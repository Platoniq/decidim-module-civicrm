class CreateDecidimCivicrmEventRegistrations < ActiveRecord::Migration[5.2]
  def change
    create_table :decidim_civicrm_event_registrations do |t|
      ...
      t.references :decidim_meeting_registration, foreign_key: { to_table: :decidim_meetings_registrations }, index: { unique: true, name: "index_civicrm_event_meeting_registration_unique" }

      t.integer :civicrm_event_registration_id
